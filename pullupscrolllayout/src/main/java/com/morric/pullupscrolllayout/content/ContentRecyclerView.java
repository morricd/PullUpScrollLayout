package com.morric.pullupscrolllayout.content;
...
public class ContentRecyclerView extends RecyclerView {
...

    {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                while (parent != null) {
                    if (parent instanceof PullUpScrollLayout) {
                        int height = ((PullUpScrollLayout) parent).getMeasuredHeight() - ((PullUpScrollLayout) parent).minOffset;
    ...
    protected void onAttachedToWindow() {
        ...
        while (parent != null) {
            if (parent instanceof PullUpScrollLayout) {
                ((PullUpScrollLayout) parent).setAssociatedRecyclerView(this);
                break;
            }
            parent = parent.getParent();
        }
